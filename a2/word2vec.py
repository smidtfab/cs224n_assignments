...
def naiveSoftmaxLossAndGradient(
    ...
    del_y_hat = y_hat.copy()
    del_y_hat[outsideWordIdx] -= 1
    # print(del_y_hat.shape)
    gradCenterVec = del_y_hat.dot(outsideVectors)
    gradOutsideVecs = del_y_hat.reshape(-1, 1).dot(centerWordVec.reshape(1, -1))
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    for outsideWord in outsideWords:
        ...
        outsideWordLoss, gradCenterVec, gradOutsideVecs = word2vecLossAndGradient(centerWordVec,
                                                    outsideWordIdx,
                                                    outsideVectors,
                                                    dataset)
