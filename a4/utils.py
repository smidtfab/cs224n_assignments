...
def pad_sents(sents, pad_token):
    ...
    #sents_padded = [nltk.pad_sequence(s, n=max_length, pad_left=False, pad_right=True, right_pad_symbol=pad_token) for s in sents]
    lengths = [len(s) for s in sents]
    max_length = max(lengths)
    for i,sent in enumerate(sents):
        sents_padded.append( sent + [pad_token] * (max_length-lengths[i]) )
    ### END YOUR CODE
