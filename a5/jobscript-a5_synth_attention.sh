...
#SBATCH -t 0-03:0:00               # how long time it will take to run
#SBATCH --gpus-per-node=A40:1       # choosing no. GPUs and their type
#SBATCH -J a5_synth_attention              # the jobname (not needed)
#SBATCH -o a5_synth_attention.out          # name of the output file
